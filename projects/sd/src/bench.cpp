...
#define SDCARD_SPI SPI1       // Or SPI1 for the second interface
...
void setup() {
  Serial.begin(9600);
  // Initialize SPI pins for RP2040
  ...
  cout << F("Using custom SPI pin configuration:\n");
  cout << F("MOSI: ") << SDCARD_MOSI_PIN << endl;
  cout << F("MISO: ") << SDCARD_MISO_PIN << endl;
  cout << F("SCK: ") << SDCARD_SCK_PIN << endl;
  cout << F("CS: ") << SDCARD_SS_PIN << endl;
